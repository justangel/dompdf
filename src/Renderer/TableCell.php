...
class TableCell extends Block
{
    ...
    function render(Frame $frame)
    {
        ...
        if ($table->get_style()->border_collapse !== "collapse") {
            ...
            // Render the background to the padding box, as the cells are rendered
            // individually one after another, and we don't want the background to
            // overlap an adjacent border
